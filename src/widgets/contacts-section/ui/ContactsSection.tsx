            ...
            {sent ? (
              <div className="mt-4 space-y-4">
                <p className="text-[15px] leading-relaxed text-muted">
                  Сформировано письмо на {siteData.email}. Нажмите кнопку ниже, чтобы открыть почтовый клиент. Если не
                  получилось — позвоните, перезвоним в рабочее время.
                </p>
                <p className="text-sm font-medium text-ink">Перезваниваем обычно в течение 15 минут в рабочее время.</p>
                <a
                  href={mailHref}
              ...
              <>
                ...
                <div className="mt-4 flex flex-col gap-2.5 sm:flex-row sm:flex-wrap">
                  <button
                    ...
                    className="inline-flex min-h-11 self-start items-center justify-center rounded-lg bg-accent px-6 py-2.5 text-base font-bold leading-none text-white transition hover:scale-[1.02] hover:bg-accentStrong active:scale-100 sm:min-w-[12rem]"
                  >
                    Онлайн-запись
                  </button>
                </div>

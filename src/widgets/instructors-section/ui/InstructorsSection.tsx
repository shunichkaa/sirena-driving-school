...
export function InstructorsSection() {
  return (
    <section id="instructors" className="border-t border-wash bg-surface py-14 md:py-20">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  ...
                  {person.name === "Байдосов Юрий Алексеевич" || person.name === "Хайруллин Алексей Хамитович" ? (
                    <>
